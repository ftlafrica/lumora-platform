...
- Enterprise Admin Dashboard sections: Command, Growth, Analytics, Payments, Finance, Users and Orgs, Support, AI Ops, Knowledge, Safety, Security, Platform, Infrastructure, API, Access, Operations
...
- The Admin Console is separated into leadership/dev operating areas: executive command, visitor growth, analytics/retention, payments, finance/cost operations, user/org management, support operations, model operations, knowledge/RAG operations, safety, security/compliance, platform operations, infrastructure/reliability, API management, access/compliance, and operations action tracking.
