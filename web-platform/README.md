...
- Enterprise Admin Dashboard sections: Command, Growth, Analytics, Experiments, Reports, Communications, Payments, Finance, Users and Orgs, Success, Support, AI Ops, Evals, Languages, Data Gov, Knowledge, Safety, Security, Platform, Infrastructure, API, Integrations, Access, Operations
...
- The Admin Console is separated into leadership/dev operating areas: executive command, visitor growth, analytics/retention, experimentation/feature flags, reporting/exports, communications, payments, finance/cost operations, user/org management, customer success, support operations, model operations, model evaluation, language intelligence, data governance/privacy ops, knowledge/RAG operations, safety, security/compliance, platform operations, infrastructure/reliability, API management, integrations/partner ops, access/compliance, and operations action tracking.
